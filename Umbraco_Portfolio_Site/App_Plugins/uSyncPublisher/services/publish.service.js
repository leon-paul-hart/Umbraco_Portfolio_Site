(function () {
    ...
    function publishService($http) {
        ...
        function getMediaFolders(key,server) {
            return $http.get(publishService + 'GetMediaFolders?id=' + key + '&server=' + server);
        }

        function getContentFolders(key, server) {
            return $http.get(publishService + 'GetContentFolders?id=' + key + '&server=' + server);
        }

        function getLocalContentFolders(key) {
            return $http.get(publishService + 'GetLocalContentFolders?id=' + key );
        }

        function getLocalMediaFolders(key) {
            return $http.get(publishService + 'GetLocalMediaFolders?id=' + key );
        }
